...
public class ResolucionFinalMapper {
    ...
    public ResolucionFinalEntity toEntity(ResolucionFinal domain) {
        ...
        return ResolucionFinalEntity.builder()
                ...
                .idQuejaRespuestaAutoridad(domain.getIdQuejaRespuestaAutoridad().longValue())
    ...
    public ResolucionFinal toDomain(ResolucionFinalEntity entity) {
        ...
        ResolucionFinal.ResolucionFinalBuilder builder = ResolucionFinal.builder()
                ...
                .idQuejaRespuestaAutoridad(entity.getIdQuejaRespuestaAutoridad() != null ? entity.getIdQuejaRespuestaAutoridad().intValue() : null)
        ...
        // ✅ CORRECCIÓN AQUÍ: Se usa getMultasCredito() directo como String
